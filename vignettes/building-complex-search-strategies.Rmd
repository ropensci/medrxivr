...
By default, a range of fields (title, abstract, authors, category, and DOI) are searched, but you can limit the search to a subset of these using the `fields` argument:
