##' Download the example data set from mcguinlu/medrxivr
...
##'   With \\code{medrxiv_del}, specifying \\code{version = NULL} will
...
##'   \\code{medrxiv_del(NULL)} (or \\code{medrxiv_del(NULL, path)} if you
...
##'   \\code{local = TRUE}.  For \\code{medrxiv_version_current}, if
...
mydata_info <- function(path) {
  datastorr::github_release_info("mcguinlu/medrxivr",
                                 filename = NULL,
                                 read = readRDS,
                                 path = path)
}
...
##' @param path Path to the data (see \\code{\\link{medrxiv}}).
##' @export
