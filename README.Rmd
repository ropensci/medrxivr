 ...
 * At present, only the title and author fields are searched. I would like to also make the author/topic fields searchable.
 * At present, only the first author for each record has been extracted. This will be corrected in future updates.
