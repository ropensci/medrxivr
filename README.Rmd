...
``` {r eval = TRUE, echo = FALSE, out.width = "500px", out.height = "400px", fig.alt = "Diagram comparing medRxiv data access from the live API and static snapshot"}
...
See here for the [snapshot release assets](https://github.com/ropensci/medrxivr/releases/tag/snapshot) and [the code that powers the `medrxivr` web app](https://github.com/mcguinlu/medrxivr-app).
